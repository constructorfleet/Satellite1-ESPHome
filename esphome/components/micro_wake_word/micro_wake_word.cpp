...
void MicroWakeWord::loop() {
  ...
  if (this->microphone_source_ != nullptr) {
    ...
    ESP_LOGD(TAG, "Audio Info => sample_rate %d channels %d bits_per_sample %d", stream_info.get_sample_rate(), stream_info.get_channels(), stream_info.get_bits_per_sample());
  }
